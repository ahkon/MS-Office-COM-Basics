...
; Note: To run this example you will probably need to open the template (Bookmarks.dotx) and click "Enable Editing".
; (Or just create your own template.) Otherwise the file will be displayed in "Protected View" because you downloaded
; it from the internet, and you will see an error when trying to run this script.
