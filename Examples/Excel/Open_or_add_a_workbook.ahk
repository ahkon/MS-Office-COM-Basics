...
; F12 hoteky        - Open a workbook in a new instance of Excel.
; Win+F11 hotkey    - Create a new blank workbook in the active instance of Excel.
; Win+F12 hoteky    - Create a new blank workbook in a new instance of Excel.
; Ctrl+F11 hotkey   - Create a new workbook in the active instance of Excel using 'FilePath' as the workbook template.
; Ctrl+F12 hoteky   - Create a new workbook in a new instance of Excel using 'FilePath' as the workbook template.
