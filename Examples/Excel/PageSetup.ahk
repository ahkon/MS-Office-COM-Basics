...
oExcel := ComObjCreate("Excel.Application")  ; Create an instance of Excel.
oExcel.Visible := true             ; Make Excel visible.
oWorkbook := oExcel.Workbooks.Add  ; Add a new blank workbook.
s1 := oExcel.Worksheets("Sheet1")  ; Save a reference to Sheet1 since we will be using that sheet several times later.
...
oExcel.PrintCommunication := msoTrue
